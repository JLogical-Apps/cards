enum Achievement {
  ...
  suitedUp('Suited Up', 'In Solitaire, complete one entire suit foundation before starting others. (Hint: Disable Auto Move in Settings)'),
  ...
  birdie('Birdie', 'Win Golf Solitaire with at least 1 card remaining in the draw pile.'),
  stackTheDeck('Stack the Deck', 'Win 5 games in a row without restarting a game.'),
